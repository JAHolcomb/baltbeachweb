...
//#permission. Copyright 1999-2013, Jim Holcomb, all rights reserved.              #
//##################################################################################
// 
*/
...
<title>Baltimore Beach Volleyball 2013 "Free Agents" List</title>
...
<div align="center">
  <table width="900" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="827"><img src="bbeachlogo.jpg" width="800" height="193"></td>
    </tr>
     <tr>  </tr>
    <tr>
      <td>&nbsp;</td>
	...
	<tr>
      <td style="padding-left:5px;"><h1 align="center" class="style1">&quot;Free Agents&quot; 2013  List </h1>

	<table width="800" >
		<tr>
		<td width="70" style="text-align:right">Filter:</td>
		...
		<td>New free agent registration <a href="http://www.baltimorebeach.com/FreeAgents/registerfreeagent.php">here</a>. Change your registration details and free agent availablity <a href="http://www.baltimorebeach.com/FreeAgents/sendlink.php">here</a>.
	</tr>
	</table>
...
$('#league-list').change(function() {
	...
	$('#tblLeague tr:not(:first) td:nth-child(3)').each(function() {
		...
		<br>
  <table id="tblLeague" width="841" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 1px thin black ">
    <tr align="center" class="altbg">
      <td width="101"><strong>Name</strong></td>
      <td width="55"><strong>Gender</strong></td>
      <td width="211"><strong>Divisions</strong></td>
      <td width="120"><strong>Email</strong></td>
	  <td width="67"><strong>Phone</strong></td>
	  <td width="74"><strong>Type</strong></td>
	  <td width="89"><strong>Time2Call</strong></td>
