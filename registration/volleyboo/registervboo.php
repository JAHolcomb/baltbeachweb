...
require_once('../../database.php');
 ...
 $lsql = "SELECT * FROM league WHERE [session] = 'Volleyboo' ORDER BY [order]";
...
//#permission. Copyright 1999-2018, Jim Holcomb, all rights reserved.              #
//##################################################################################
// 
*/
...
<title>Baltimore Beach 5th Annual &quot;VolleyBoo&quot; Tournament Oct 14th, 2017</title>
...
<body background="n7SuRmb.jpg" style="background-image: url('n7SuRmb.jpg')">
...
<table width="1037" height="956" border="0" align="center" cellpadding="0" bordercolor="#000000" bgcolor="#000000">
  ...
  <tr>
    <td colspan="7" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#FF9900"><div align="center"><img src="announcement4.jpg" width="1029" height="100" /></div></td>
  </tr>
  <tr>
    <td colspan="2" valign="bottom" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><div align="center"><<span class="orange4vboo"><span class="ghoul"><span class="title_large_underlined">Team Information</span></span></span>
    </span></span><span class="small_note_orange"><br />
    (fields marked * are required)</span></div></td>
    <td width="3" rowspan="19" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><span class="style2"></span></td>
    <td colspan="4" valign="bottom" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><div align="center"><span class="orange4vboo"><span class="ghoul"><span class="title_large_underlined">Player Information</span></span></span><br />
        <span class="small_note_orange11">*Do not add team captain as a playeror you may be double-billed</span></div>      <div align="center"></div></td>
  </tr>
  <tr>
    <td height="20" align="right" bgcolor="#000000" class="orange4vboo"><span class="ghoul">*Team Name:</span></td>
    <td width="315" bordercolor="#000000" bgcolor="#000000">
      <input name="teamname" type="text" id="teamname" tabindex="1" size="25" maxlength="50" /></td>
    <td width="73" rowspan="2" bgcolor="#000000">&nbsp;</td>
    <td width="184" rowspan="2" bgcolor="#000000">    
      <div align="center" class="orange4vboo">Name</div>
      <td width="184" rowspan="2" bgcolor="#000000"><div align="center" class="orange4vboo">
        Email</div></td>
    <td width="48" rowspan="2" bgcolor="#000000"><div align="center" class="style10"></div>
  ...
  <tr>
    ...
    <td bgcolor="#000000" class="orange4vboo"><select name="league" id="league" tabindex="2" >
      <option value="" selected="selected">- Select Vboo Type/Division -</option>
  ...
  <tr>
    <td align="right" bgcolor="#000000"><span class="orange4vboo"><span class="ghoul">When:</span></span></td>
    <td width="315" bgcolor="#000000"><span class="orange4vboo"><strong>Sunday, October 21st, 2018</strong></span></td>
    <td width="73" bgcolor="#000000" class="orange4vboo"><div align="center"><span class="orange4vboo">
		Player 1</span></div></td>
    <td width="184" bgcolor="#000000"><input name="player1_name" type="text" id="player1_name" tabindex="16" size="30" maxlength="50" /></td>
  ...
  <tr>
    <td height="20" colspan="2" align="right" bgcolor="#000000"><div align="center"><font face="Arial" class="medgrey" style="font-size: 9pt; font-style: italic">*Registration        begins at 11:00am, tournament starts at 12 noon</font></div></td>
  ...
  <tr>
    <td height="20" align="right"><span class="orange4vboo"><span class="ghoul">Who</span>:</span></td>
  ...
  <tr>
    ...
    <td class="orange4vboo">$30 per player Coed 4's and Coed 6's (*prepaid)</td>
    <td width="73" bgcolor="#000000" class="orange4vboo"><div align="center"><span class="orange4vboo">
      Player 4</span></div></td>
    <td width="184" bgcolor="#000000"><span class="style2">
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#000000"><span class="orange4vboo"><span class="orange4vboo"><span class="ghoul"><span class="title_large_underlined">Captain's Information</span></span></span></td>
    <td width="73" bgcolor="#000000" class="orange4vboo"><div align="center" class="orange4vboo">Player 
      5</div></td>
    <td width="184" bgcolor="#000000"><span class="style2">
  ...
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*First Name</span></span></td>
    <td width="315"><input name="cpt_first" type="text" id="cpt_first" tabindex="6" size="25" maxlength="50" /></td>
   <td width="73" bgcolor="#000000" class="orange4vboo"><div align="center" class="orange4vboo">Player 
     6</div></td>
    <td width="184" bgcolor="#000000"><span class="style2">
  ...
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*Last Name</span></span></td>
    <td width="315"><input name="cpt_last" type="text" id="cpt_last" tabindex="7" size="25" maxlength="50" /></td>
    <td width="73" bgcolor="#000000" class="orange4vboo"><div align="center" class="orange4vboo">Player 
      7</div></td>
    <td width="184" bgcolor="#000000"><span class="style2">
  ...
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*Address</span></span></td>
    <td width="315"><input name="cpt_address" type="text" id="cpt_address" tabindex="8" size="25" maxlength="50" /></td>
    <td width="73" bgcolor="#000000" class="orange4vboo"><div align="center" class="orange4vboo">Player 
      8</div></td>
    <td width="184" bgcolor="#000000"><span class="style2">
  ...
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*City</span></span></td>
    <td width="315"><input name="cpt_city" type="text" id="cpt_city" tabindex="9" size="25" maxlength="25" /></td>
    <td width="73" bgcolor="#000000"><div align="center" class="style18"></div></td>
    <td width="184" bgcolor="#000000">&nbsp;</td>
    <td width="184" bgcolor="#000000">&nbsp;</td>
    <td bgcolor="#000000">&nbsp;</td>
    </tr>
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*State</span></span></td>
    <td width="315"><select name="cpt_state" id="cpt_state" tabindex="10">
  ...
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*Zip</span></span></td>
    <td width="315"><input name="cpt_zip" type="text" id="cpt_zip" tabindex="11" size="10" maxlength="10" /></td>
    </tr>
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*Phone</span></span></td>
  ...
  <tr>
    <td align="right"><span class="orange4vboo"><span class="orange4vboo">*Email</span></span></td>
    <td width="315"><input name="cpt_email" type="text" id="cpt_email" tabindex="13" size="25" maxlength="40" /></td>
    </tr>
...
<table width="749" border="0" align="center">
  <tr>
    <td width="745"><div align="center"><span class="style38">Copyright © 1999 - 
        ...
        <span class="style38">Revised:October 10, 2018</span></div></td>
  </tr>
</table>
</form>
</body>
