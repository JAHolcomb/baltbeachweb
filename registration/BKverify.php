...
*/
    ...
    define ( "MAIL_SUBJECT" , "%s has been registered for the Big Kahuna Tournament 2015!" );
...
<title>2014 Team Registration Complete</title>
  ...
  <div id="container">
    <div id="banner">
      ...
      <p font face="Comic Sans MS">Thank you for registering with Baltimore 
		Beach "Big Kahuna" Tournament 2015!  <br />
        Please <strong><a href="javascript:window.print()">PRINT</a></strong> this page 
		for your records.<br /><strong><br>
        Registration is not considered complete until team fees have been paid.</strong><br />
      ...
      <h2><b><u>BK Tourney Info:</u></b></h2>
      <p font face="Comic Sans MS">
        <strong>BK Tourney Type:</strong>: <?php echo $arrLeagueSearch["session"] . " " . $arrLeagueSearch["night"] . " " . $arrLeagueSearch["type"] . " " . $arrLeagueSearch["size"] . " " . $arrLeagueSearch["division"]; ?><br />
        <strong>BK Team Name</strong>: <?php echo $arrPost["teamname"]; ?><br />
        <strong>No. of Players</strong>: <?php echo $intPlayers; ?><br />
        <strong>Tourney Fees Due</strong>: $<?php echo $dblBase; ?><br />
      ...
      <div align="center">
        ...
        <span class="style98">*Please enter "Big Kahuna" Tournament on memo line</span>
      </p>
      <p align="left">
        <u>
      ...
      <p align="left">
        <span class="style33">*** League payments now accepted via PayPal ***</span><br />
      			...
      			<p align="left">
      <a href="http://www.baltimorebeach.com/kahuna/paypalkahuna.htm" target="_self"><img src="http://www.baltimorebeach.com/images/paypal.jpg" width="150" height="52" hspace="61" border="0" longdesc="http://www.baltimorebeach.com/images/paypal.jpg"></a><br />
...
******************************************************************************<br>
<strong>BK Tournament Team Name</strong>:  $arrPost[teamname]<br>
<strong>BK Tournament Team Info</strong>: $arrLeagueSearch[session] $arrLeagueSearch[night] $arrLeagueSearch[type] $arrLeagueSearch[size] $arrLeagueSearch[division] Division<br>

<strong>Team Players</strong>:  <br>$strPlayers <br><br>
    
+++ <strong><u>Team Captain Login Information</u></strong> +++<br><br>

<strong>Team Captain:</strong>: $arrPost[cpt_first] $arrPost[cpt_last] <br><br>
...
<strong>PayPal Page</strong>: <a href="http://www.baltimorebeach.com/kahuna/paypalkahuna.htm">Big Kahuna PayPal Page</a> <br><br>

NOTE:  Registration is not considered complete until Tournament fees have been paid.<br>    
******************************************************************************  
MAILBODY;
