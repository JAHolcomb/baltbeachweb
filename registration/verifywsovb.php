...
*/
    ...
    $strTeamSearch    = "SELECT t_id FROM team WHERE league = 88 AND teamname='%s'";
    $strLeagueSearch  = "SELECT * FROM league WHERE l_id = 88";
...
<?php
     ...
     */
	$intVenueID = 'ASICS 6s WSOVB Qualifier';
...
<html>
  ...
  <div id="container">
    <div id="banner">
      <img border="0" src="bsobv3.jpg">
      <h3>Team &quot;<?php echo $arrPost["teamname"]; ?>&quot; Registration for <?php echo $arrPost["venue"]; ?> Tournament!</h3>
      ...
      <p font face="Comic Sans MS">
        <strong>Tournament</strong>: ASICS WCoed 6's WSOVB Qualifier Tournament<br />
        ...
        <strong>Tournament Fees Due</strong>: $200<br />
        </p>
      ...
      <div align="center">
		<table border="0" width="100%">
			<tr>
				<td>
				<p align="left">
        <span class="style99">Make (one) Tournament Qualifier registration check payable to</span><strong>:</strong>&nbsp; <span class="style34">
		Baltimore Beach</span><br />
        <span class="style98">*Please enter team name and WSOBV Tournament on memo line</span>
      </p>
      <p align="left">
        <u>
      ...
      <p align="left">
        <span class="style33">*** Tournament payments now accepted via PayPal ***</span><br />
      			...
      			<p align="left">
      <a href="http://www.baltimorebeach.com/registration/PayPalAsics.htm" target="_self"><img src="http://www.baltimorebeach.com/images/paypal.jpg" width="150" height="52" hspace="61" border="0" longdesc="http://www.baltimorebeach.com/images/paypal.jpg"></a><br />
