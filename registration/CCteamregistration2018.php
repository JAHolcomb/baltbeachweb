...
<title>Baltimore Beach 2018 "Corporate Challenge" Team Registration Form</title>
...
<form name="register" id="register" method="post" action="CorpChallengeVerify.php">

<table width="1152" height="731" border="0" align="center" cellpadding="0" bordercolor="#000000" bgcolor="#000000">
  <tr>
    <td height="64" colspan="8" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><img src="../CorporateChallenge/Charities.jpg" width="1148" height="261" /></td>
  </tr>
  <tr>
    <td height="64" colspan="8" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#FFCC33"><div align="center">
      <p><span class="style11">Baltimore Beach &quot;Corporate Challenge&quot;<br />
        2018        Team Registration Form</span></p>
</div></td>
  </tr>
  <tr>
    ...
    <td width="13" rowspan="20" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><span class="style2"></span></td>
  ...
  <tr>
    <td width="189" height="22" align="right" bgcolor="#3E3E3E"><span class="style37">
	*Team Name&nbsp; </span></td>
    <td width="262" bordercolor="#000000" bgcolor="#3E3E3E">
		<input name="teamname" type="text" id="teamname" tabindex="1" size="27" maxlength="50" /></td>
    <td width="151" rowspan="2" bgcolor="#3E3E3E">&nbsp;</td>
    <td width="142" rowspan="2" bgcolor="#3E3E3E">    
      <div align="center" class="style10">Name</div>
    <td width="159" rowspan="2" bgcolor="#3E3E3E"><div align="center" class="style10">
		Email</div></td>
    <td colspan="2" rowspan="13" bgcolor="#3E3E3E">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="right" bgcolor="#3E3E3E">&nbsp;</td>
    <td width="151" bgcolor="#3E3E3E"><div align="center"><span class="style18">
      Player 1</span></div></td>
    <td width="142" bgcolor="#3E3E3E"><input name="player1_name" type="text" id="player1_name" tabindex="16" size="23" maxlength="50" /></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player1_email" type="text" id="player1_email" tabindex="17" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    <td colspan="2" rowspan="2" align="center" bgcolor="#000000">&nbsp;</td>
    <td width="151" bgcolor="#3E3E3E"><div align="center"><span class="style18">Player 2</span></div>
      <span class="style2"></span></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
  ...
  <tr>
    <td width="151" height="22" align="right" bgcolor="#3E3E3E"><div align="center"><span class="style18">
      Player 3</span></div></td>
    <td width="142" align="left" bgcolor="#3E3E3E"><span class="style2">
  ...
  <tr>
    <td height="22" colspan="2" align="right" bgcolor="#3E3E3E">&nbsp;</td>
    <td width="151" bgcolor="#3E3E3E"><div align="center"><span class="style18">
      Player 4</span></div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
      <input name="player4_name" type="text" id="player4_name" tabindex="28" size="23" maxlength="50" /></span></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player4_email" type="text" id="player4_email" tabindex="29" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    ...
    <td width="151" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      5</div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
      <input name="player5_name" type="text" id="player5_name" tabindex="32" size="23" maxlength="50" />
    </span></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player5_email" type="text" id="player5_email" tabindex="33" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    ...
    <td width="159" bgcolor="#3E3E3E"><input name="player6_email" type="text" id="player6_email" tabindex="37" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    <td width="189" align="right" bgcolor="#3E3E3E"><span class="style37"> 
	*First Name&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E"><input name="cpt_first" type="text" id="cpt_first" tabindex="6" size="25" maxlength="50" /></td>
    <td width="151" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      7</div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
      <input name="player7_name" type="text" id="player7_name" tabindex="40" size="23" maxlength="50" />
    </span></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player7_email" type="text" id="player7_email" tabindex="41" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    <td width="189" align="right" bgcolor="#3E3E3E"><span class="style37"> *Last 
	Name&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E"><input name="cpt_last" type="text" id="cpt_last" tabindex="7" size="25" maxlength="50" /></td>
    <td width="151" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      8</div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
      <input name="player8_name" type="text" id="player8_name" tabindex="44" size="23" maxlength="50" />
    </span></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player8_email" type="text" id="player8_email" tabindex="45" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    <td width="189" align="right" bgcolor="#3E3E3E"><span class="style37"> 
	*Address&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E"><input name="cpt_address" type="text" id="cpt_address" tabindex="8" size="25" maxlength="50" /></td>
    <td width="151" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      9</div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
      <input name="player9_name" type="text" id="player9_name" tabindex="48" size="23" maxlength="50" />
    </span></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player9_email" type="text" id="player9_email" tabindex="49" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    <td width="189" height="24" align="right" bgcolor="#3E3E3E"><span class="style37"> 
	*City&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E"><input name="cpt_city" type="text" id="cpt_city" tabindex="9" size="25" maxlength="25" /></td>
    <td width="151" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      10</div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
      <input name="player10_name" type="text" id="player10_name" tabindex="52" size="23" maxlength="50" />
    </span></td>
    <td width="159" bgcolor="#3E3E3E"><input name="player10_email" type="text" id="player10_email" tabindex="53" size="25" maxlength="40" /></td>
    </tr>
  <tr>
    <td width="189" align="right" bgcolor="#3E3E3E"><span class="style37"> 
	*State&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E">
    ...
    <td width="151" bgcolor="#3E3E3E"><div align="center" class="style18">Player 11</div></td>
    <td width="142" bgcolor="#3E3E3E"><span class="style2">
  ...
  <tr>
    <td width="189" align="right" bgcolor="#3E3E3E"><span class="style37"> *Zip&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E"><input name="cpt_zip" type="text" id="cpt_zip" tabindex="11" size="10" maxlength="10" /></td>
...
<img src="../images/preload.gif" alt="loading...">
    ...
    <td width="216" rowspan="4" bgcolor="#000000"><div align="center"></div></td>
    <td width="2" rowspan="4" bgcolor="#000000">&nbsp;</td>
    </tr>
  <tr>
    <td width="189" align="right" bgcolor="#3E3E3E"><span class="style37"> 
	*Email&nbsp; </span></td>
    <td width="262" bgcolor="#3E3E3E"><input name="cpt_email" type="text" id="cpt_email" tabindex="13" size="27" maxlength="40" /></td>
    </tr>
  <tr>
    ...
    <tr>
    <td align="right" bgcolor="#3E3E3E">&nbsp;</td>
    <td bgcolor="#3E3E3E" class="style18">&nbsp;</td>
    </tr>  
  <tr>
...
<table width="749" border="0" align="center">
  <tr>
    <td width="745"><div align="center"><span class="style38">Copyright © 1999 - 
        ...
        <span class="style38">Revised: May 14th, 2018</span></div></td>
  </tr>
</table>
</form>
<script type="text/javascript">
