...
*/
    ...
    $strTeamSearch    = "SELECT t_id FROM team WHERE league = 87 AND teamname='%s'";
    $strLeagueSearch  = "SELECT * FROM league WHERE l_id = 87";
...
//die;
 ...
 $intLeagueID = 87;
    ...
    (
        $strTeamSearch,
        $intLeagueID, /* Removing ability to have duplicate team names in different leagues */
        $arrPost["teamname"]
    );
...
<title>BBV Presents the World Series of Volleyball Regional Qualifier Tournament 2014!</title>
...
<?php
     ...
     */
	$intVenueID = 'Charity Challenge 2014';
...
<html>
  ...
  <div id="container">
    <div id="banner">
      ...
      <h3>Team &quot;<?php echo $arrPost["teamname"]; ?>&quot; Registration for Charity Challenge 2014 Tournament!</h3>
      ...
      <p font face="Comic Sans MS">
        <strong>Tournament</strong>: Baltimore Beach Charity Challenge Tournament 2014!<br />
      ...
      <div align="center">
		<table border="0" width="100%">
			<tr>
				<td>
				<p align="left">
        <span class="style99">Make (one) Charity Challenge registration check payable to</span><strong>:</strong>&nbsp; <span class="style34">
		Baltimore Beach</span><br />
        <span class="style98">*Please enter team name and Charity Challenge Tournament on memo line</span>
      </p>
      <p align="left">
        <u>
      ...
      <p align="left">
        <span class="style33">*** Tournament payments now accepted via PayPal ***</span><br />
      			...
      			<p align="left">
      <a href="http://www.baltimorebeach.com/registration/PayPalCharityChallenge.htm" target="_self"><img src="http://www.baltimorebeach.com/images/paypal.jpg" width="150" height="52" hspace="61" border="0" longdesc="http://www.baltimorebeach.com/images/paypal.jpg"></a><br />
...
<strong>BBV Venue</strong>: Baltimore Beach Charity Challenge 2014 Tournament<br>

<strong>Players</strong>:  <br>$strPlayers <br><br>
    

NOTE:  Registration is not considered complete until team fees have been paid.<br>
<a href="http://www.baltimorebeach.com/registration/PayPalCharityChallenge.htm"</a>
...
$message->AddAddress("charity@baltimorebeach.com");
$message->Subject   = $strMailSubject;
$message->Body      = $strMailBody;
