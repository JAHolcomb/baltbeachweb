...
$privatekey = "6Lf8d8ISAAAAAJ5msZWKiTE9C-S_wSrZhCXL2aub";
...
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>2011 Summer Session Team Registration Confirmation</title>
  ...
  <body>
    ...
    <div id="banner">
      ...
      <h3>Team <?php echo $arrPost["teamname"]; ?> Registration for "Summer" Leagues 2011!</h3>
      ...
      <p font face="Comic Sans MS">
        <strong>BBV League</strong>: Summer <?php echo $arrLeagueSearch["night"] . " " . $arrLeagueSearch["type"] . " " . $arrLeagueSearch["size"] . " " . $arrLeagueSearch["division"]; ?><br />
...
<strong>BBV League</strong>: Summer $arrLeagueSearch[night] $arrLeagueSearch[type] $arrLeagueSearch[size] $arrLeagueSearch[division] Division<br>
