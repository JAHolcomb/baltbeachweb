...
<div id="banner">
      ...
      <h3>Hello <?php echo $arrPost["first"] . " " . $arrPost["last"]; ?>. Your registration for "Clinics with NVL Pros" has been received.</h3>
  <p font face="Comic Sans MS">*Registration is not considered complete until clinic fees have been paid.<br />
      </p>
       <p>
        Make registration check payable to Baltimore Beach<br />
        *Please enter Clinics with NVL Pros on memo line</span>
        <br>
...
******************************************************************************<br>
$arrPost[first] $arrPost[last], your <strong>Clinics with NVL Pros</strong> registration has been recieved.<br><br>

<strong>Clinic Date: </strong> Sunday, May 22nd, 2011<br>
<strong>Clinic Time: </strong> 11am to 1pm<br><br>
