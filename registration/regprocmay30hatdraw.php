<?php   
  // Your code here to handle a successful verification 
     ...
     * MsSQL settings
     */
    define ( "MSSQL_SERVER"   , "209.17.116.4" );
     ...
     * MsSQL queries
     */
    $strNameInsert = "INSERT INTO hatdraw (name,email,phone,gender,size,division) VALUES ('%s','%s','%s','%s','%s','%s')";
...
mssql_select_db("baltimorebeach");
  ...
  $sql = "INSERT INTO hatdraw ($keys) VALUES ($values)";
  mssql_query($sql);
...
<html>
  <head>
    ...
    <title>Baltimore Beach Memorial Day Hat Draw Tournament</title>
    <link rel="stylesheet" href="jahstyles.css" type="text/css" />
</head>
<body>
<table width="98%" border="0">
  <tr>
    <td><div id="container_center" >
<div id="banner">
      <img border="0" src="nvlprosclinics.jpg">
      <h3>Hello <?php echo $arrPost["name"]; ?>. Your Memorial Day "Hat Draw" registration has been received.</h3>
  <p font face="Comic Sans MS">*Registration is not considered complete until tournament fees have been paid.<br />
      </p>
       <p>
        Make registration check payable to Baltimore Beach<br />
        *Please enter "Hat Draw" on memo line</span>
        <br>
...
Baltimore, MD  21230
      ...
      <a href="http://www.baltimorebeach.com/hatdraw/PayPalHatDraw.htm" target="_self"><img src="http://www.baltimorebeach.com/images/paypal.jpg" width="150" height="52" hspace="61" border="0" longdesc="http://www.baltimorebeach.com/images/paypal.jpg"></a><br />
...
<?php
	...
	$strMailSubject = sprintf(MAIL_SUBJECT,$arrPost["name"]);

    $strMailBody = <<<MAILBODY
******************************************************************************<br>
$arrPost[first] $arrPost[last], your <strong>Memorial Day "Hat Draw"</strong> tournament registration has been recieved.<br><br>

<strong>Tournament Date: </strong> Monday, May 30th, 2011<br>
<strong>Registration Opens: </strong> 9am <br>
<strong>Tournament Starts: </strong> 10am <br>

<strong>NOTE: </strong> Registration is not considered complete until tournament fees have been paid.<br>
