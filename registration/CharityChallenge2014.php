...
<title>Baltimore Beach Charity Challenge 2014 Team Registration Form</title>
...
<form name="register" id="register" method="post" action="verifyCC2.php">

<table width="1072" height="731" border="0" align="center" cellpadding="0" bordercolor="#000000" bgcolor="#000000">
  <tr>
    <td height="64" colspan="7" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><img src="CharityChallenge2014.jpg" width="1076" height="402" align="middle" /></td>
  </tr>
  <tr>
    <td height="64" colspan="7" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#FFCC33"><div align="center">
      <p><span class="style11">Baltimore Beach Charity Challenge 2014 <br />
  ...
  <tr>
    ...
    <td width="4" rowspan="17" bordercolor="#000000" bordercolorlight="#000000" bgcolor="#000000"><span class="style2"></span></td>
  ...
  <tr>
    <td width="97" height="22" align="right" bgcolor="#3E3E3E"><span class="style37">
	*Team Name&nbsp; </span></td>
    <td width="285" bordercolor="#000000" bgcolor="#3E3E3E">
		<input name="teamname" type="text" id="teamname" tabindex="1" size="25" maxlength="50" /></td>
    <td width="69" rowspan="2" bgcolor="#3E3E3E">&nbsp;</td>
    <td width="180" rowspan="2" bgcolor="#3E3E3E">    
      <div align="center" class="style10">Name</div>
    <td width="180" rowspan="2" bgcolor="#3E3E3E"><div align="center" class="style10">
		Email</div></td>
    <td width="241" rowspan="2" bgcolor="#3E3E3E"><div align="center" class="style10"></div></td>
    </tr>
  <tr>
    <td colspan="2" align="right" bgcolor="#3E3E3E">
      <div align="left"></div></td>
    </tr>
  <tr>
    <td align="right" bgcolor="#3E3E3E">&nbsp;</td>
    <td bgcolor="#3E3E3E"><div align="left"><span class="style37">Charity Challenge 2014! </span></div></td>
    <td width="69" bgcolor="#3E3E3E"><div align="center"><span class="style18">
      Player 1</span></div></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player1_name" type="text" id="player1_name" tabindex="16" size="30" maxlength="50" /></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player1_email" type="text" id="player1_email" tabindex="17" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span style="width: 10%"></td>
    </tr>
  <tr>
    <td width="97" height="24" align="right" bgcolor="#3E3E3E">&nbsp;</td>
    <td bgcolor="#3E3E3E"><span class="style37">May 31st, 2014! Start time 9am</span></td>
  ...
  <tr>
    <td align="right" bgcolor="#3E3E3E">&nbsp;</td>
    <td bgcolor="#3E3E3E"><span class="style37">$500 per team of 10 ($60 each additional player)</span></td>
  ...
  <tr>
    ...
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player4_name" type="text" id="player4_name" tabindex="28" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player4_email" type="text" id="player4_email" tabindex="29" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" align="right" bgcolor="#3E3E3E"><span class="style37"> *First Name&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><input name="cpt_first" type="text" id="cpt_first" tabindex="6" size="25" maxlength="50" /></td>
    <td width="69" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      5</div></td>
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player5_name" type="text" id="player5_name" tabindex="32" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player5_email" type="text" id="player5_email" tabindex="33" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" align="right" bgcolor="#3E3E3E"><span class="style37"> *Last 
      Name&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><input name="cpt_last" type="text" id="cpt_last" tabindex="7" size="25" maxlength="50" /></td>
    <td width="69" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      6</div></td>
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player6_name" type="text" id="player6_name" tabindex="36" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player6_email" type="text" id="player6_email" tabindex="37" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" align="right" bgcolor="#3E3E3E"><span class="style37"> *Address&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><input name="cpt_address" type="text" id="cpt_address" tabindex="8" size="25" maxlength="50" /></td>
    <td width="69" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      7</div></td>
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player7_name" type="text" id="player7_name" tabindex="40" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player7_email" type="text" id="player7_email" tabindex="41" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" height="24" align="right" bgcolor="#3E3E3E"><span class="style37"> *City&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><input name="cpt_city" type="text" id="cpt_city" tabindex="9" size="25" maxlength="25" /></td>
    <td width="69" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      8</div></td>
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player8_name" type="text" id="player8_name" tabindex="44" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player8_email" type="text" id="player8_email" tabindex="45" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" align="right" bgcolor="#3E3E3E"><span class="style37"> *State&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><select name="cpt_state" id="cpt_state" tabindex="10">
    ...
    <td width="69" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      9</div></td>
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player9_name" type="text" id="player9_name" tabindex="48" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player9_email" type="text" id="player9_email" tabindex="49" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" align="right" bgcolor="#3E3E3E"><span class="style37"> *Zip&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><input name="cpt_zip" type="text" id="cpt_zip" tabindex="11" size="10" maxlength="10" /></td>
    <td width="69" bgcolor="#3E3E3E"><div align="center" class="style18">Player 
      10</div></td>
    <td width="180" bgcolor="#3E3E3E"><span class="style2">
      <input name="player10_name" type="text" id="player10_name" tabindex="52" size="30" maxlength="50" /></span></td>
    <td width="180" bgcolor="#3E3E3E"><input name="player10_email" type="text" id="player10_email" tabindex="53" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    ...
    <td bgcolor="#3E3E3E"><span class="style2">
      <input name="player11_name" type="text" id="player11_name" tabindex="56" size="30" maxlength="50" />
    </span></td>
    <td bgcolor="#3E3E3E"><input name="player11_email" type="text" id="player11_email" tabindex="57" size="30" maxlength="40" /></td>
    <td bgcolor="#3E3E3E"><span></td>
    </tr>
  <tr>
    <td width="97" align="right" bgcolor="#3E3E3E"><span class="style37"> *Email&nbsp; </span></td>
    <td width="285" bgcolor="#3E3E3E"><input name="cpt_email" type="text" id="cpt_email" tabindex="13" size="25" maxlength="40" /></td>
    <td colspan="3" rowspan="2" bgcolor="#000000"><div align="right">
      <input name="Submit" type="submit" tabindex="60" value="Register" />
    </div></td>
    <td rowspan="2" bgcolor="#000000"><div align="center"></div></td>
    </tr>
  <tr>
    <td align="right" bgcolor="#3E3E3E"><span class="style37">&nbsp; </span></td>
    <td bgcolor="#3E3E3E">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" align="right" bgcolor="#333333"><div align="center"></div></td>
  </table>
<br />
<table width="749" border="0" align="center">
  <tr>
    <td width="745"><div align="center"><span class="style38">Copyright © 1999 - 
        ...
        <span class="style38">Revised: May 4th, 2014</span></div></td>
  </tr>
</table>
</form>
</body>
